...
icon1 = pygame.image.load(os.path.join(assets_path, "..", "assets", "icon1.png")).convert_alpha()
icon2 = pygame.image.load(os.path.join(assets_path, "..", "assets", "icon2.png")).convert_alpha()
icon3 = pygame.image.load(os.path.join(assets_path, "..", "assets", "icon3.png")).convert_alpha()
